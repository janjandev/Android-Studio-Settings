 ...
 */
public class AppFragment extends BaseFragment implements CompoundButton.OnCheckedChangeListener {
    ...
    {
        ViewGroup content= (ViewGroup) inflater.inflate(R.layout.fragment_app,container,false);
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new AppChoiceFragment();
                case 1:
                    return new AppCommonUseFragment();
                case 2:
                    return new AppNaviFragment();
            }
            return new AppChoiceFragment();
        }
    ...
    private void initTabLayout() {
        View tabLayout = ((MainActivity) getActivity()).getCustomViewByLayoutId(
                R.layout.tab_layout_toolbar_app);
